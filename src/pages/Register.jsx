  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-yellow-100 to-yellow-400 p-4">
      <div className="bg-white rounded-2xl shadow-xl flex w-full max-w-6xl overflow-hidden">
        <img src={pig} alt="Piggy bank" className="w-180 h-auto object-fill" />
        ...
        <div className="w-1/2 p-10">
          ...
          <form className="space-y-4">
            <div>
              <label className="block text-yellow-900 mb-1" htmlFor="name">
                Họ và tên
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-yellow-900 mb-1" htmlFor="email">
                Email
              </label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-yellow-900 mb-1" htmlFor="password">
                Mật khẩu
              </label>
              <input
                type="password"
